...
namespace WindowsFormsApplication1
{
    public partial class Form2 : System.Windows.Forms.Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            context.Load(web);
            context.ExecuteQuery();
            List list = context.Web.Lists.GetByTitle("اجرای کانال بتنی درجا (درجه 3)");

            ContentType ct = list.ContentTypes.GetById("0x0100D8A26FE13DBAF245884D5F0BCDDD3C1E00849668C7546990479EB648C9A7E280BD");
        ...
        private int GetLookupId(string listname, object lookupVal, int cID)
        {
            ...
            contextTo.Load(lookupList);
            //    contextTo.ExecuteQuery();
            var q = new CamlQuery() { ViewXml = string.Format(@"<View Scope='RecursiveAll'><Query>
                                                       <Where>
                                                          <And>
                                                             <Eq>
                                                                <FieldRef Name='Contract' LookupId = 'TRUE'/>
